...
const Comments = () => {
  ...
  const setModalVisibility = (modalVisibility, event) => {
    event.preventDefault();
    setModalVisible(modalVisibility);
  };

  const onClickOK = (modalVisibility) => {
    setModalVisible(modalVisibility);
    ...
    setComments([
      ...comments,
      {
        ...
        content: <p>{value}</p>,
        rate: <Rate disabled allowHalf defaultValue={rate} />,
      },
    ]);
  };
  ...
  return (
    <div className="comment-body">
            ...
            <form>
              <div className="input-type-box">
                <Input
                  ...
                  readOnly
                  placeholder="Comment"
                  onClick={(e) => setModalVisibility(true, e)}
                />
                <Button
                  htmlType="submit"
                  loading={submitting}
      ...
      <Modal
        ...
        onOk={() => onClickOK(false)}
        okText="Post"
        width="728px"
        onCancel={(e) => setModalVisibility(false, e)}
